...
namespace Microsoft.EntityFrameworkCore.Query.PipeLine
{
    public abstract class QueryableMethodTranslatingExpressionVisitor : ExpressionVisitor
    {
                    ...
                    switch (methodCallExpression.Method.Name)
                    {
                        ...
                        case nameof(Queryable.All):
                            ...
                            return TranslateAll(
                                ...
                                TryUnwrapLambdaFromQuoteExpression(methodCallExpression.Arguments[1]));
                        ...
                        case nameof(Queryable.GroupBy):
                            {
                                var keySelector = TryUnwrapLambdaFromQuoteExpression(methodCallExpression.Arguments[1]);
                                ...
                                switch (argumentCount)
                                {
                                    ...
                                    case 3:
                                        var lambda = TryUnwrapLambdaFromQuoteExpression(methodCallExpression.Arguments[2]);
                                    ...
                                    case 4:
                                        return TranslateGroupBy(
                                            shapedQueryExpression,
                                            keySelector,
                                            TryUnwrapLambdaFromQuoteExpression(methodCallExpression.Arguments[2]),
                                            TryUnwrapLambdaFromQuoteExpression(methodCallExpression.Arguments[3]));
                                }
                            }
                        ...
                        when argumentCount == 5:
                            {
                                ...
                                if (innerSource is ShapedQueryExpression innerShapedQueryExpression)
                                {
                                    return TranslateGroupJoin(
                                        ...
                                        TryUnwrapLambdaFromQuoteExpression(methodCallExpression.Arguments[2]),
                                        TryUnwrapLambdaFromQuoteExpression(methodCallExpression.Arguments[3]),
                                        TryUnwrapLambdaFromQuoteExpression(methodCallExpression.Arguments[4]));
                                }
                            }
        ...
        private LambdaExpression TryUnwrapLambdaFromQuoteExpression(Expression expression)
